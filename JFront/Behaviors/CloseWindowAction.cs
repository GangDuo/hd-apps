...
namespace JFront.Behaviors
{
    class CloseWindowAction
    {
        ...
        // Using a DependencyProperty as the backing store for Close.
        // This enables animation, styling, binding, etc...
        public static readonly DependencyProperty CloseProperty = DependencyProperty.RegisterAttached("Close", typeof(bool), typeof(CloseWindowAction), new PropertyMetadata(false, OnCloseChanged));
